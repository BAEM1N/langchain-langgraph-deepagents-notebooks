# Time travel — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langchain/frontend/time-travel
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langchain__frontend__time-travel.md`
> 수집일: 2026-06-19

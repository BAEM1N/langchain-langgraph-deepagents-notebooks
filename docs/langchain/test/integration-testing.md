# Integration testing — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langchain/test/integration-testing
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langchain__test__integration-testing.md`
> 수집일: 2026-06-19
...
테스트·평가 트랙 보강 후보다. `06_langsmith`의 Agent Evals와 연결해 unit/integration/eval 경계를 설명한다.

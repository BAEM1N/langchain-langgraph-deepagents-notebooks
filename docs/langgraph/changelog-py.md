# Changelog Py — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langgraph/changelog-py
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langgraph__changelog-py.md`
> 수집일: 2026-06-19
...
버전 변화가 빠른 문서다. 강의 코드 갱신 시 회귀 테스트와 함께 확인한다.

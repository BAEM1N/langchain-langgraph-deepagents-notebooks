# Fault tolerance — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langgraph/fault-tolerance
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langgraph__fault-tolerance.md`
> 수집일: 2026-06-19
...
재시도, timeout, error handler, durable execution의 경계를 분리해 설명한다.

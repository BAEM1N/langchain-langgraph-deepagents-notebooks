# Custom stream channels — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langgraph/frontend/custom-stream-channels
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langgraph__frontend__custom-stream-channels.md`
> 수집일: 2026-06-19

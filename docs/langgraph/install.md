# Install LangGraph — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langgraph/install
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langgraph__install.md`
> 수집일: 2026-06-19
...
패키지 설치와 Python 버전 전제 확인용이다. 이 저장소는 `uv`와 `pyproject.toml`을 기준으로 통일한다.

# Backward compatibility — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/langgraph/backward-compatibility
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__langgraph__backward-compatibility.md`
> 수집일: 2026-06-19
> 문서 성격: LangGraph 레퍼런스 보강 노트
...
이미 있는 노트북/문서와 중복되는지 확인한 뒤, 강의 본문에는 필요한 최소 예제만 반영한다.

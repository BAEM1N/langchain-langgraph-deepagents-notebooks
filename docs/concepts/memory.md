# Memory overview — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/concepts/memory
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__concepts__memory.md`
> 수집일: 2026-06-19
...
thread-local checkpoint와 cross-thread store/long-term memory를 혼동하지 않도록 한다.

# Providers and models — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/concepts/providers-and-models
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__concepts__providers-and-models.md`
> 수집일: 2026-06-19
> 문서 성격: 공통 개념 레퍼런스 보강 노트
...
세 프레임워크 공통 배경 지식이다. 초급 개요와 프레임워크 선택 장에서 cross-reference한다.

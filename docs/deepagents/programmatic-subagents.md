# Programmatic subagents — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/programmatic-subagents
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__programmatic-subagents.md`
> 수집일: 2026-06-19
...
현재 코스에서는 dependency gate를 먼저 확인하고, live notebook은 선택 기능으로 둔다.

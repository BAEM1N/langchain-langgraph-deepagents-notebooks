# Models — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/models
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__models.md`
> 수집일: 2026-06-19
...
provider별 모델 선택 정책과 기본 모델명을 동기화할 때 확인한다.

# A2A endpoint in Agent Server — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/a2a
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__a2a.md`
> 수집일: 2026-06-19
...
Agent Server/프로토콜 통합 영역이므로 기본 01~07 실습보다 `08_integration` 후보에 가깝다.

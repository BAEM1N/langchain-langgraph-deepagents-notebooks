# Model Context Protocol (MCP) — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/mcp
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__mcp.md`
> 수집일: 2026-06-19
...
외부 도구 연결 표준이다. 키/서버 준비가 필요한 예제는 integration track으로 분리한다.

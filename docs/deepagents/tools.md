# Tools — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/tools
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__tools.md`
> 수집일: 2026-06-19
...
도구 스키마, 권한, 에러 처리 규칙을 노트북 예제와 맞춘다.

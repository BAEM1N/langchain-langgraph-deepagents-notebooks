# Use remote sandboxes — Official Reference Note

> 공식 원문: https://docs.langchain.com/oss/python/deepagents/code/remote-sandboxes
> 로컬 원문 스냅샷: `local/official_langchain_docs_2026-06-19/pages/oss__python__deepagents__code__remote-sandboxes.md`
> 수집일: 2026-06-19
...
Deep Agents Code/CLI 운영 표면이다. 기본 교육 노트북보다는 `08_integration` appendix 후보로 둔다.
